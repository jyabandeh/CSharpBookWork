...
namespace C11PP03_HourlyPaySorter.EmployeeDataSetTableAdapters {
...
SELECT EmployeeID, Name, Position, HourlyPayRate FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::C11PP03_HourlyPaySorter.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        EmployeeID, Name, Position, HourlyPayRate\r\nFROM            Employee" +
                "\r\nORDER BY HourlyPayRate";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        EmployeeID, Name, Position, HourlyPayRate\r\nFROM            Employee" +
                "\r\nORDER BY HourlyPayRate DESC";
        ...
        public virtual int FillByPayAsc(EmployeeDataSet.EmployeeDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByPayDesc(EmployeeDataSet.EmployeeDataTable dataTable) {
