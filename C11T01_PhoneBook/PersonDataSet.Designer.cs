...
namespace C11T01_PhoneBook.PersonDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Person] SET [Name] = @Name, [Phone] = @Phone WHERE (([PersonID] = @" +
                "Original_PersonID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone)" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::C11T01_PhoneBook.Properties.Settings.Default.PhonelistConnectionString;
        }
